  ...
  return (
    <div className="flex h-full flex-col bg-papier">
      ...
      <div className="flex justify-center pt-2 pb-1 shrink-0 bg-papier">
        <div className="inline-flex rounded-full bg-white p-1 shadow-[0_2px_10px_rgba(232,101,24,0.08)]">
          <button
            type="button"
            ...
            className={`rounded-full px-5 py-1.5 text-xs font-bold transition-all ${
              melodieModus === "fliessend"
                ? "bg-[#E86518] text-white shadow-sm"
...
function Hinweis({
  ...
  if (uebung.fehler) {
    ...
    return <span className="text-[#E86518] font-medium">{text} — noch einmal von vorn.</span>;
  }
